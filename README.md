...
- <a href="https://github.com/Shruti-131202/Telco_Customer_Churn_Analysis/blob/main/Telco_Churn_prediction.ipynb">Random Forest Classisier</a>
- Used Python to train a Random Forest model.
